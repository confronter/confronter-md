...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const Confronter='254101003655';
             const Confronter1='254793908571';
             const Confronter2='254793908571'*/
            /*  var superUser=[servBot,Confronter,Confronter1,luffy].map((s)=>s.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);
              var dev =[Confronter,Confronter1,Confronter2].map((t)=>t.replace(/[^0-9]/g)+"@s.whatsapp.net").includes(auteurMessage);*/
            ...
            const Confronter = '254793908571';
            const Confronter1 = '254101003655';
            const Confronter2 = "254793908571";
            const Confronter3 = '254101003655';
            ...
            var dev = [Confronter, Confronter1,Confronter2,Confronter3].map((t) => t.replace(/[^0-9]/g) + "@s.whatsapp.net").includes(auteurMessage);
            function repondre(mes) { zk.sendMessage(origineMessage, { text: mes }, { quoted: ms }); }
            console.log("\t [][]...{CONFRONTER-MD}...[][]");
...
https://chat.whatsapp.com/G9wfBIfRrGZJJ70mEGcAnU

║✅ *FOLLOW THE DEVELOPER* 😍 
https://instagram.com/confronter._
